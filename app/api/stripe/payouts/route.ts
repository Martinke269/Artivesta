...
import { payoutListQuerySchema } from '@/lib/validation/stripe-schemas';
 ...
 * Returns payout history for a gallery
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const validatedParams = payoutListQuerySchema.parse(queryParams);
