...
import { BuyerInvoicesFilters } from '@/lib/supabase/buyer-invoices-queries'

interface InvoicesFiltersProps {
  filters: BuyerInvoicesFilters;
  onFiltersChange: (filters: BuyerInvoicesFilters) => void;
...
export function InvoicesFilters({
  ...
  const handleFilterChange = (key: keyof BuyerInvoicesFilters, value: any) => {
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Søg efter faktura ID, kunstværk, kunstner..."
